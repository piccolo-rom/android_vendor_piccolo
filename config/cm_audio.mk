...
ALARM_PATH := vendor/piccolo/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/piccolo/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/piccolo/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/piccolo/prebuilt/common/media/audio/ui
